...
def send_welcome(message):
    ...
    bot.send_message(message.chat.id, "<b>✅ Bem-Vindo, {}</b>" .format(message.chat.first_name) + "<b> ! ✅\n\n</b>"
...
def vip1(message):
    ...
    bot.send_message(userID, "📣 <b>Benefícios do Grupo VIP:</b>\n"
                             "🔺 Apostas Diárias\n"
                             "🔺 Apostas Live\n"
                             "🔺 Apostas Pré-Live\n"
    ...
    bot.send_message("375387984","==========\n  <b>ENTRADA</b> \n ==========\n -> <b>ID:</b> {}" .format(userID) + " || <b>Username:</b> @{}\n" .format(userNome) + 
